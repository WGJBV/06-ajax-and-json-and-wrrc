...
// It's called on line 50. It's pulling from the JSON file. In the previous lab we were pulling from an object from blogArticles.js called rawData.
...
Article.fetchAll = () => {
  ...
  if (localStorage.rawData) {
    ...
    // It's different because we're loading it from localStorage. The benefits are in caching to make the page laod faster upon every visit or refresh.
